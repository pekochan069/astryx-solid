...
function Svg(props: SvgProps) {
  const rest = omit(props, "solid", "strokeWidth", "children");
  ...
  return (
    <svg
      ...
      stroke={props.solid ? undefined : "currentColor"}
      stroke-width={props.solid ? undefined : (props.strokeWidth ?? 1.5)}
...
export const defaultIcons: Record<IconName, IconType> = {
  close: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
      <path d="M6 6l12 12M6 18L18 6" />
    </Svg>
  ),

  chevronDown: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
      <path d="M6 9l6 6 6-6" />
    </Svg>
  ),

  chevronLeft: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
      <path d="M15 6l-6 6 6 6" />
    </Svg>
  ),

  chevronRight: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
      <path d="M9 6l6 6-6 6" />
    </Svg>
  ),

  check: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
      <path d="M5 13l4 4L19 7" />
    </Svg>
  ),

  success: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props} solid>
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
  ...
  error: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props} solid>
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
  ...
  warning: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props} solid>
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
  ...
  info: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props} solid>
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
  ...
  calendar: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
  ...
  clock: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
  ...
  externalLink: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
  ...
  menu: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props} strokeWidth={2}>
      <path d="M4 6h16M4 12h16M4 18h16" />
    </Svg>
  ),

  moreHorizontal: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props} solid>
  ...
  search: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
  ...
  arrowUp: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
      <path d="M12 19V5m0 0l-7 7m7-7l7 7" />
    </Svg>
  ),

  arrowDown: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
      <path d="M12 5v14m0 0l7-7m-7 7l-7-7" />
    </Svg>
  ),

  arrowsUpDown: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
      <path d="M3 7.5L7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5" />
    </Svg>
  ),

  funnel: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
  ...
  eyeSlash: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
      <path d="M3.98 8.223A10.477 10.477 0 001.934 12c1.292 4.338 5.31 7.5 10.066 7.5.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88" />
    </Svg>
  ),

  viewColumns: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
  ...
  copy: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
  ...
  checkDouble: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
  ...
  wrench: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
      <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" />
    </Svg>
  ),

  stop: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props} solid>
      <rect x="6" y="6" width="12" height="12" rx="2" />
    </Svg>
  ),

  microphone: (props: JSX.SvgSVGAttributes<SVGSVGElement>) => (
    <Svg {...props}>
